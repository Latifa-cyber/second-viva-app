...
import 'package:second_app/ResultViva.dart';
...
class _VivaMarkPage1State extends State<VivaMarkPage1> {
  ...
  Mark() {
    return ((double.parse(supervisorMark.text.trim()) * 6 +
                double.parse(presidentMark.text.trim()) * 6 +
                double.parse(examinatorMark.text.trim()) * 8) /
            20)
        .toString();
  }
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          onSaved: (value) => {projectName.text != value},
                          validator: (value) {
                            if (value!.isEmpty) {
                          ...
                          decoration: InputDecoration(
                              ...
                              border: OutlineInputBorder(
                                borderSide: BorderSide(
                                    color: Color(0xFF120D3A), width: 22.0),
                                borderRadius: BorderRadius.circular(10.0),
                              ),
                              focusedBorder: OutlineInputBorder(
                                  borderSide: BorderSide(
                                      color: Color(0xFF120D3A), width: 2.0),
                                  borderRadius: BorderRadius.circular(10.0))),
                        ),
                      ),
                      FieldName('Year:'),
                      ...
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          onSaved: (value) => {supervisorMark.text != value},
                          validator: (value) {
                            if (value!.isEmpty) {
                              return 'please fill this field';
                            }
                      ...
                      Container(
                        margin: EdgeInsets.symmetric(
                            horizontal: 30.0, vertical: 7.0),
                        child: TextFormField(
                          controller: presidentMark,
                          onChanged: (value) {
                            pstMark = value;
                          },
                          onSaved: (value) => {presidentMark.text != value},
                          validator: (value) {
                            if (value!.isEmpty) {
                              return 'please fill this field';
                            }
                      ...
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          onSaved: (value) => {examinatorMark.text != value},
                          validator: (value) {
                            if (value!.isEmpty) {
                              return 'please fill this field';
                            }
